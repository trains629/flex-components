const inputProps =  [
  ...
  {caption:"选项",type:"InputOptions",name: "options",
    defaultValue:{"kind":"sort",value:{"list":[]}}
  },
]; 

function selectStringType(){
  return {caption:"类型",type:"SelectType",name:".type",
  info:{
    list:[
...
const list = {
  ...
  "Date" : [
    {caption:"标题",type:"String",name: "caption",defaultValue:""},
    {caption:"描述信息",type:"Text",name: "description",defaultValue:""},
    {caption:"默认值",type:"String",name:"defaultValue",
      info:{
        readOnly : true,
        list:[
          {"caption":"无","value":""},
...
const Field = {
  ...
  //"Int" : {"type":"FieldInt",attribute:{"caption":"Int"}},
...
export default {props:{list,defaultValue},list:Field};