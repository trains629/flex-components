...
function Description({children, small}) {
  function parse(str) {
    let reg = /\{\{\s+(.*?)\s+\}\}/g;
    let count = 2;
  ...
  return small ? /* @__PURE__ */ React5.createElement("small", {
    className: "form-text text-muted"
  }, list) : /* @__PURE__ */ React5.createElement(React5.Fragment, null, list);
}
function FormCaption(props) {
  ...
  return /* @__PURE__ */ React5.createElement("label", {
    ...
    className: "label-notnull"
  }, "*") : null);
}
function FormGroup(props) {
  let {children, className, description, caption, invalid} = props;
  return /* @__PURE__ */ React5.createElement("div", {
    className: classNames3("form-group", className)
  }, caption ? /* @__PURE__ */ React5.createElement(FormCaption, null, caption) : null, children, invalid ? /* @__PURE__ */ React5.createElement("div", {
    className: "invalid-feedback",
    key: "invalid"
  }, invalid) : /* @__PURE__ */ React5.createElement(Description, {
    key: "description",
    small: true
  }, description));
}
...
function CheckBox(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    className: "form-check",
    description,
    invalid: invalidStr
  }, /* @__PURE__ */ React5.createElement(Input, __assign(__assign({}, props), {
    type: "checkbox",
    className: classNames3("form-check-input", className, getInvalidClass(invalidStr))
  })), /* @__PURE__ */ React5.createElement(FormCaption, {
    key: type,
    notNull
  }, caption));
}
function TextBox(props) {
  let {className, caption, description, type, notNull, invalidStr} = props;
  className = classNames3("form-control", className, getInvalidClass(invalidStr));
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    description,
    invalid: invalidStr
  }, /* @__PURE__ */ React5.createElement(FormCaption, {
    key: type,
    notNull
  }, caption), /* @__PURE__ */ React5.createElement(Text, __assign(__assign({}, props), {
    className
  })));
}
function InputBox(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    key: type,
    notNull
  }, caption), /* @__PURE__ */ React5.createElement(Input, __assign(__assign({}, props), {
    className
  })));
}
...
function DropdownList(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    key: type,
    notNull
  }, caption), /* @__PURE__ */ React5.createElement(InputGroupList, __assign(__assign({}, props), {
    readOnly: true,
    type: options.type,
    className: classNames3("form-control", className, getInvalidClass(invalidStr)),
    value: value || list,
...
function InputList(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    return /* @__PURE__ */ React5.createElement("div", __assign({
      className: "form-check",
      key: `${key}_${i}`
    }, divArgs), /* @__PURE__ */ React5.createElement("input", __assign({}, args)), /* @__PURE__ */ React5.createElement(FormCaption, {
      className: "form-check-label"
    }, caption2), invalidStr ? /* @__PURE__ */ React5.createElement("div", {
      className: "invalid-feedback",
...
function CheckGroup(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    }, /* @__PURE__ */ React5.createElement("input", __assign({}, args)), /* @__PURE__ */ React5.createElement(FormCaption, {
      className: "form-check-label"
    }, caption2), invalidStr ? /* @__PURE__ */ React5.createElement("div", {
      className: "invalid-feedback",
      style: {display: "inline"},
...
function SelectType(props) {
  ...
  return /* @__PURE__ */ React5.createElement(Dropdown.Dropdown, {
...
function FormInputComponent(Input3, type, kind) {
  return function(props) {
    ...
    return /* @__PURE__ */ React6.createElement(Input3, __assign(__assign(__assign({}, props), attrs), {
      setValue: (value) => {
        if (typeof setValue === "function")
...
function CantainerComponent(Cantainer4, type) {
  return function(props) {
    let attribute = getAttribute(props);
    let {children} = props;
    return /* @__PURE__ */ React6.createElement(Cantainer4, __assign(__assign(__assign({}, props), {attribute, type}), children));
  };
}
...
const ID = /* @__PURE__ */ React7.createElement(React7.Fragment, null);
...
function Panel(props) {
  ...
  return /* @__PURE__ */ React8.createElement("div", {
    ...
    style
  }, /* @__PURE__ */ React8.createElement(Caption, {
    className: "card-header"
  }, caption), /* @__PURE__ */ React8.createElement(SubCantainer, {
    className: classNames4("card-body", "flex-Sub-cantainer", {row})
...
function Tab(props) {
  ...
  return /* @__PURE__ */ React9.createElement(TabCard, {
    index,
    onClick: (e, value) => {
      updateComponentValue({key: "index", value});
    },
    itemdata: (item, id) => /* @__PURE__ */ React9.createElement(SubCantainer, {
...
function Table(props) {
  ...
  return /* @__PURE__ */ React10.createElement("table", {
    className: "table"
  }, /* @__PURE__ */ React10.createElement("tbody", null, Array.isArray(children) ? children.map((item, index) => /* @__PURE__ */ React10.createElement(SubCantainer, {
    key: `tr_${index}`,
    tagName: "tr"
  }, item)) : null));
}
...
function Grid(props) {
  ...
  return /* @__PURE__ */ React11.createElement("div", {
    className: classNames5(className, "row", "flex-component-grid", "flex-grid-fixed")
    ...
    return /* @__PURE__ */ React11.createElement(SubCantainer, {
      key: `${index}_${name}`,
      flex,
      className: classNames5(className2, "flex-component-grid")
    }, item);
  }) : null);
}
...
// src/index.js
const Form3 = Form_default;
const Cantainer3 = Cantainer_default;
function src_default(ComponentStore) {
