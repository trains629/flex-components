...
import React5, {createElement, useState as useState3} from "react";
...
function FormGroup(props) {
  ...
  }, caption ? /* @__PURE__ */ React5.createElement(FormCaption, null, caption) : null, /* @__PURE__ */ React5.createElement("div", {
    className: "control"
...
function CheckBox(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    key: type,
    className: classNames3("checkbox", getInvalidClass(invalidStr)),
    notNull
...
function SelectBox(props) {
  ...
  className = classNames3(className, "input", getInvalidClass(invalidStr));
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    key: type,
    notNull
  }, caption), /* @__PURE__ */ React5.createElement("div", {
    className: "select"
  ...
  }, list ? list.map(({caption: caption2, value: value2}, index) => /* @__PURE__ */ React5.createElement("option", {
    key: `${index}`,
    value: value2
  }, caption2)) : null)));
}
function TextBox(props) {
  let {className, caption, description, type, notNull, invalidStr} = props;
  className = classNames3(className, "textarea", getInvalidClass(invalidStr));
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    description,
    invalid: invalidStr
  }, /* @__PURE__ */ React5.createElement(FormCaption, {
...
function DropdownList(props) {
  ...
  return /* @__PURE__ */ React5.createElement(FormGroup, {
    ...
    readOnly: true,
    type: options.type,
    className: classNames3(className, getInvalidClass(invalidStr)),
    value: value || list,
    key,
...
function CantainerComponent(Cantainer3, type) {
  return function(props) {
    ...
    let {children} = props;
    return /* @__PURE__ */ React6.createElement(Cantainer3, __assign(__assign(__assign({}, props), {attribute, type}), children));
  };
}
...
function Panel(props) {
  ...
  return /* @__PURE__ */ React8.createElement("div", {
    className: classNames4(className, "message"),
    style
  }, /* @__PURE__ */ React8.createElement(Caption, {
    className: "message-header"
  }, caption), /* @__PURE__ */ React8.createElement(SubCantainer, {
    className: classNames4("message-body", "flex-Sub-cantainer", {columns})
...
function Button(props) {
  ...
  const className = classNames6(cl, "button");
